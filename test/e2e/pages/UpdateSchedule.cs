...
namespace pre.test.pages
{
  public class UpdateSchedule : BasePage
  {
   ...
   public static DateTime today = DateTime.Today;
      ...
      protected static ILocator Scheduledcase = HooksInitializer._context.Page.Frame("fullscreen-app-host").Locator($" div:nth-child(19) > div div.virtualized-gallery:has-text(\"{stringCase}\")");
